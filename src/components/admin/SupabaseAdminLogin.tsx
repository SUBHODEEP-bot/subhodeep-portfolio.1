...
const SupabaseAdminLogin = ({ onLogin }: SupabaseAdminLoginProps) => {
  const [email, setEmail] = useState('subhodeeppal2005@gmail.com');
      ...
      <div className="max-w-md w-full bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/10 shadow-2xl relative z-10">
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-500">
            Please use your Supabase admin credentials. If you've forgotten your password, you can reset it via the Supabase dashboard.
          </p>
        </div>
      </div>
    </div>
